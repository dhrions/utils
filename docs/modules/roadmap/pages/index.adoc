...
. On commence par l'xref:dev.adoc#algo[algorithmie].
. On apprend à se servir d'un xref:transversal.adoc#ide[IDE].
. On apprend à se servir de xref:transversal.adoc#git[Git et GitHub].
