...
De même que l'on peut parcourir un champ de blé ou champ de vin (en 2 dimensions en l'occurrence, avec une surface courbée), on peut parcourir le champ électromagnétique.
