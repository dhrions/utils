= Natural language process avec Python
Dhrions
Version 1.0.0, 16/06/2024
// Document attributes
:sectnums:                                                          
:toc:                                                   
:toclevels: 5  
...
Il semble y avoir 2 principaux paquets pour faire du traitement du langage naturel (_nature language process_) avec Python :

* ntlk (_nature language toolkit_) ;
* spacy.
